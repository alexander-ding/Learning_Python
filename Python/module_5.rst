...
第一节介绍了一些编写“好代码”的指导方针。具体来讲，它将为你指向很多Python社区的用户使用的风格守则。它也介绍了相对新但越来越流行的Python功能，叫做类暗示（type hinting）。它允许我们提供类说明文档注释来完善我们代码的可读性。读者也将接触NumPy和Google的编写好docstring（说明字符串）的守则。
